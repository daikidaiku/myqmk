...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                                   KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , S(KC_MINS),
                  KC_LALT,KC_LGUI,LCTL_T(KC_LNG2),LT(1,KC_SPC),LT(3,KC_LNG1),                     KC_BSPC,LT(2,KC_ENT), RCTL_T(KC_LNG2),     KC_RALT  , LT(4,KC_ESC)
  ),

  [1] = LAYOUT_universal(
    _______  ,  KC_1    , KC_2     , KC_3    , KC_4     , KC_5     ,                                         KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , _______  ,
    _______  ,  _______ , _______  , _______ , KC_ENT   ,S(RGUI(KC_5)),                                      _______  , KC_4     , KC_5     , KC_6     , _______  , _______  ,
    _______  ,  _______ , _______  ,RGUI(KC_C),S(RGUI(KC_V)),KC_BSPC,                                        KC_0     , KC_1     , KC_2     , KC_3     , _______  , _______  ,
                  _______  , _______ , _______  ,         _______  , _______  ,                   _______  , KC_DOT   , _______       , _______  , _______
  ),

  [2] = LAYOUT_universal(
    _______  ,S(KC_1)   , S(KC_2)  , S(KC_3) , S(KC_4) , S(KC_5)  ,                                         S(KC_6)  , S(KC_7)  , S(KC_8)  , S(KC_9)     , S(KC_0)  , _______  ,
    _______  ,S(KC_SCLN), _______  , _______ , _______ , KC_RBRC  ,                                         KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT     , KC_QUOT  , S(KC_2)  ,
    _______  ,S(KC_MINS), _______  , _______ , _______ ,S(KC_RBRC),                                     LCTL(KC_LEFT), RGUI(KC_LEFT), RGUI(KC_RGHT)  ,LCTL(KC_RGHT),S(KC_SLSH),S(KC_INT3),
